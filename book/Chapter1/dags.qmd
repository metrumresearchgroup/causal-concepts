...
* Treatment variables will be underlined (like $\underline{D}$) and outcome variables will be overlined (like $\overline{R}$). 
...
#| fig-dpi: 300
    ...
    \node[] (E) at (3,3) {$\underline{E}$};
    \node[] (R) at (6,3) {$\overline{R}$};
